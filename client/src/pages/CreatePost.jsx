  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w-[500px]'>Create your images through DALL-E AI and share them with the community!</p>
      </div>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5'>
          ...
          <FormField 
            ...
            type="text"
            name="prompt"
            placeholder="sunshin in the rain"
            value={form.prompt}
            handleChange={handleChange}
            isSurpriseMe
        ...
        <div className='mt-5 flex gap-5'>
          <button type='button' onClick={generateImage} className='text-white bg-green-700 font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center'>
            {generatingImg ? 'Processing' : 'Generate'}
          </button>
        </div>

        <div className='mt-10'>
          <p className='mt-2 text-[#666e75] text-[14px]'>Once you are satisfied with the image, you can share it with the community</p>
